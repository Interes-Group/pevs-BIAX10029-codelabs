...
See instructions in the [site directory's readme](docs/README.md).

## How do I generate a custom view?

Copy the [sample view](docs/app/views/vslive), customize it to your liking,
...
The [site directory](docs) contains tools for building your own custom landing page(s) and publishing both landing
